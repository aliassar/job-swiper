...
export function JobProvider({ children }) {
  ...
  // Fetch jobs and saved jobs on mount - ONLY when authenticated
  useEffect(() => {
    // Don't fetch anything if not authenticated
    if (!session) {
      return;
    }
  ...
  }, [session, offlineQueue, fetchJobs, fetchSavedJobs, fetchApplications, fetchReportedJobs, fetchSkippedJobs]);
