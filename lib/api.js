...
export const applicationsApi = {
  ...
  // Verify/reject/rollback CV documents
  ...
  // Handle message verification and sending
...
export const notificationsApi = {
  ...
  markAsRead: (notificationIds) => apiRequest('/api/notifications', {
    method: 'POST',
    body: JSON.stringify({ notificationIds, read: true }),
  }),
  
  // Mark all notifications as read
  markAllAsRead: () => apiRequest('/api/notifications', {
    method: 'POST',
    body: JSON.stringify({ notificationIds: [], read: true }),
  }),
...
export const emailApi = {
  ...
  disconnect: () => apiRequest('/api/email', {
    method: 'DELETE',
  }),
...
export const userApi = {
  // Get user settings
  getSettings: () => apiRequest('/api/user'),
  
  // Update user settings
  updateSettings: (settings) => apiRequest('/api/user', {
    method: 'PUT',
