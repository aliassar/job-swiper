...
class OfflineQueue {
  ...
  async processQueue() {
    ...
    // Buffer for operations added during processing
    const pendingBuffer = [];
    
    // Flag to track if new operations were added during processing
    ...
    // If operations were added during processing, process them
    // This prevents race condition where operations are added while processing=true
